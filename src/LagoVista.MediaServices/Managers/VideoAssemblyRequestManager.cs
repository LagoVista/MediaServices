...
namespace LagoVista.MediaServices.Managers
{
    public class VideoAssemblyRequestManager : IVideoAssemblyRequestManager
    {
        ...
        public async Task<InvokeResult<VideoAssemblyPreparationResult>> PrepareAssemblyRequestAsync(string compositionId, double? thumbnailTimeSeconds, EntityHeader org, EntityHeader user, CancellationToken cancellationToken = default)
        {
            ...
            var videoDestinationResult = await _videoProcessorStorageUrlService.CreateWriteDestinationAsync(org.Id, pendingRevision.StorageReferenceName, "video/mp4", VideoProcessorStorageUrlScope.Internal, cancellationToken);
            ...
            var thumbnailDestinationResult = await _videoProcessorStorageUrlService.CreateWriteDestinationAsync(org.Id, pendingRevision.ThumbnailStorageReferenceName, "image/jpeg", VideoProcessorStorageUrlScope.Internal, cancellationToken);
