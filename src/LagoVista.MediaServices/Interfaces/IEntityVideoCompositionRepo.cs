...
namespace LagoVista.MediaServices.Interfaces
{
    public interface IEntityVideoCompositionRepo
    {
        ...
        Task<InvokeResult> PatchVideoCompositionInfoAsync(string entityType, string entityId, string orgId, string name, string key, EntityVideoCompositionInfo videoCompositionInfo, EntityHeader user, CancellationToken cancellationToken = default);
    }
}
