...
namespace LagoVista.MediaServices.Interfaces
{
    public interface IEntityVideoCompositionRepo
    {
        ...
        Task<InvokeResult> PatchVideoCompositionInfoAsync(string entityType, string entityId, string orgId, EntityVideoCompositionInfo videoCompositionInfo, EntityHeader user, CancellationToken cancellationToken = default);
    }
}
