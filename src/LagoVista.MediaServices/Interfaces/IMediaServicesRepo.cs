...
namespace LagoVista.MediaServices.Interfaces
{
    public interface IMediaServicesRepo
    {
        ...
        Task<InvokeResult<string>> GetMediaReadUrlAsync(string blobReferenceName, string org, System.TimeSpan lifetime, System.Threading.CancellationToken cancellationToken = default);
